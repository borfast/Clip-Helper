...
A funcionalidade do CLIP Helper foi implementada no CLIP e está actualmente em testes, portanto, caso seja mantida, este script poderá brevemente deixar de ser necessário. Ver: https://forum.fct.unl.pt/cgi-bin/topic_show.pl?tid=2457
...
Aqui está um pequeno vídeo que ilustra o efeito pretendido. Primeiro o comportamento normal do CLIP, sem o CLIP Helper, e depois com o CLIP Helper: http://www.youtube.com/watch?v=gI6bm06v5ZQ
